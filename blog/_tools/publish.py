...
def render_post_html(slug, title, topic, date_str, excerpt, body_md, cover_filename):
    canonical = f"https://harshaldasani.pages.dev/blog/posts/{slug}/"
...
{{
  ...
  "@graph": [
    {{"@type": "Person", "@id": "https://harshaldasani.pages.dev/#person", "name": "Harshal Dasani", "url": "https://harshaldasani.pages.dev/"}},
    {{"@type": "BlogPosting", "headline": "{title}", "description": "{excerpt}", "datePublished": "{date_str}", "image": "{canonical}{cover_filename}", "url": "{canonical}", "author": {{"@id": "https://harshaldasani.pages.dev/#person"}}, "publisher": {{"@id": "https://harshaldasani.pages.dev/#person"}}, "mainEntityOfPage": "{canonical}", "articleSection": "{topic}"}}
  ]
}}
</script>
